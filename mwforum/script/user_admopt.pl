...
if (!$submitted || @{$m->{formErrors}}) {
	...
	print
		...
		"<input type='text' class='fcs' name='userName' size='80' maxlength='$cfg->{maxUserNameLen}'",
		...
		"<input type='text' name='oldNames' size='80' value='$oldNamesEsc'/></label>",
	...
	print
		"</select></label>\n",
		"<input type='text' name='title' size='80' value='$titleEsc'/>\n",
		"</fieldset>\n",
		"<fieldset>\n",
