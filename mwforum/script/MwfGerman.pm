...
$lng->{avaUplFile}   = "JPG/PNG/GIF-Bild, keine Animation, max. Größe [[bytes]] Bytes, genaue Dimensionen [[width]]x[[height]] Pixel.";
$lng->{avaUplResize} = "JPG/PNG/GIF-Bild, keine Animation, max. Größe [[bytes]] Bytes.";
