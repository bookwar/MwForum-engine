...
},
{
	...
	default  => { English => "MwfEnglish", German => "MwfGerman", Russian => "MwfRussian" },
},
{
	name     => 'languageCodes',
	type     => 'textarea',
	...
	example  => [ "en=English" ],
	default  => { en => "English", de => "German", ru => "Russian" },
},
{
	name     => 'styles',
	type     => 'textarea',
...
},
{
	name     => 'avatarResize',
	type     => 'checkbox',
	title    => "Automatically reformat uploaded avatars that don't conform to restrictions?",
	default  => 0,
},
{
	name     => 'avatarMaxSize',
...
},
{
	name     => 'avatarWidth',
	type     => 'number',
	title    => "Exact width of avatars in pixels",
	default  => 50,
},
{
	name     => 'avatarHeight',
	type     => 'number',
	title    => "Exact height of avatars in pixels",
	default  => 50,
},
{
...
},
{
	...
	help     => "Can be used for Firefox <a href='http://wiki.mozilla.org/Microsummaries'>Live Titles</a>. Requires feeds to be set up, too.",
	default  => 0,
},
{
	name     => 'rssItems',
...
},
{
	name     => 'advSearch',
	type     => 'checkbox',
	title    => "Enable indexed search mode for MySQL?",
	help     => "See FAQ.html for details.",
	default  => 0,
},
{
...
},
{
	...
	radio    => [
		0 => "No",
		1 => "Yes, enable search with results shown on Google site",
		2 => "Yes, enable AJAX search with results in mwForum (<a href='http://code.google.com/apis/ajaxsearch/terms.html'>Terms of Use</a>)",
	],
	default  => 0,
},
{
