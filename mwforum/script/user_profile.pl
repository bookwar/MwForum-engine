...
if (!$submitted || @{$m->{formErrors}}) {
	...
	print
		...
		"<input type='text' class='fcs' name='realName' size='40' maxlength='100'",
		" autofocus='autofocus' value='$realNameEsc'/></label>\n",
		"<label class='lbw'>$lng->{uopProfBdate}\n",
		"<input type='text' name='birthdate' size='40' maxlength='10' value='$birthdateEsc'",
		" pattern='\\d{4}-\\d{2}-\\d{2}|\\d{2}-\\d{2}'/></label>\n",
		"<label class='lbw'>$lng->{uopProfPage}\n",
		"<input type='url' name='homepage' size='80' maxlength='100' value='$homepageEsc'/></label>\n",
		"<label class='lbw'>$lng->{uopProfOccup}\n",
		"<input type='text' name='occupation' size='80' maxlength='100' value='$occupationEsc'/></label>\n",
		"<label class='lbw'>$lng->{uopProfHobby}\n",
		"<input type='text' name='hobbies' size='80' maxlength='100' value='$hobbiesEsc'/></label>\n",
		"<label class='lbw'>$lng->{uopProfLocat}",
		" <a class='clk' id='loc' style='display: none'>$lng->{uopProfLocIn}</a>\n",
		"<input type='text' name='location' size='80' maxlength='100' value='$locationEsc'/></label>\n",
		"<label class='lbw'>$lng->{uopProfIcq}\n",
		"<input type='text' name='icq' size='80' maxlength='100' value='$icqEsc'/></label>\n",
		$cfg->{extra1} && $cfg->{regExtra1} < 2 ? "<label class='lbw'>$cfg->{longExtra1}\n" . 
			"<input type='text' name='extra1' size='80' maxlength='255' value='$extra1Esc'/></label>\n" : "",
		$cfg->{extra2} && $cfg->{regExtra2} < 2 ? "<label class='lbw'>$cfg->{longExtra2}\n" .
			"<input type='text' name='extra2' size='80' maxlength='255' value='$extra2Esc'/></label>\n" : "",
		$cfg->{extra3} && $cfg->{regExtra3} < 2 ? "<label class='lbw'>$cfg->{longExtra3}\n" .
			"<input type='text' name='extra3' size='80' maxlength='255' value='$extra3Esc'/></label>\n" : "",
