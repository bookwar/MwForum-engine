...
$lng->{avaUplFile}   = "JPG/PNG/GIF image, no animation, max. size [[bytes]] bytes, exact dimensions [[width]]x[[height]] pixels.";
$lng->{avaUplResize} = "JPG/PNG/GIF image, no animation, max. size [[bytes]] bytes.";
